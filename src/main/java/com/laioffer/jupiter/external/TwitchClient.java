...
public class TwitchClient {
    private static final String TOKEN = "Bearer ozfxe9nxycxbcu7agymoo75sgric1g";
    private static final String CLIENT_ID = "8unoj3citos3xnyqpmpuv1sacl2nze";
    ...
    private String buildGameURL(String url, String gameName, int limit) {
        if (gameName.equals("")) { // top game api: https://api.twitch.tv/helix/games/top?first=20
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        // responseHandler : lambda expression
